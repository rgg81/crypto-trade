#!/usr/bin/env python3
"""Recompute the frozen Team 12 replay or report its released golden stream."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Team 12 continuous IS + confirmation + historical-OOS replay. By default this "
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("reports/team12"),
        help="output directory (default: reports/team12)",
    )
