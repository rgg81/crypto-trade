#!/usr/bin/env python3
"""One-screen observational digest for the Team 12 paper desk."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Team 12 paper performance digest")
    parser.add_argument(
        "--paper-dir",
        type=Path,
    ...
    print("=== Team 12 exact-replay paper desk — observational digest ===")
    print(
