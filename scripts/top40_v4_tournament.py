#!/usr/bin/env python3
"""Canonical organizer CLI for the Top-40 V4 tournament."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if arguments.command == "validate":
            result = orchestrator_v4.validate(root, require_activation=not arguments.pre_activation)
            ...
            result = orchestrator_v4.retire(root, arguments.team_id, reason=arguments.reason)
