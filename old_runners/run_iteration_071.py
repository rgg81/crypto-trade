"""Iter 071: 4-symbol universe — BTC+ETH+SOL+DOGE.

Same as iter 068 (ensemble, ATR, cooldown=2, 106 features).
Change: expanded from 2 to 4 symbols.
"""
import sys
import time
...
def main(seed: int = 42) -> None:
    print(f"Iter 071: ensemble, cooldown=2, ATR, 4 symbols (BTC+ETH+SOL+DOGE)")
