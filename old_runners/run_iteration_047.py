"""Iter 047: BTC+ETH, 24mo, TP=8%/SL=4%, timeout=7 days (10080min), fail-fast.

Iter 046 had 42.4% WR but negative PnL — timeout trades drag it down.
Longer timeout (7 days) gives trades more time to reach the 8% TP target.
"""
import sys, time
...
def main() -> None:
    print(f"Iter 047: BTC+ETH, 24mo, TP=8%/SL=4%, timeout=7days")
