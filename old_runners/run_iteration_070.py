"""Iter 070: Feature engineering — 13 new features (interaction + cross-asset).

Same as iter 068 (ensemble, ATR, cooldown=2).
Change: 119 features (106 baseline + 6 interaction + 7 xbtc cross-asset).
"""
import sys
import time
...
def main(seed: int = 42) -> None:
    print(f"Iter 070: ensemble + new features (interaction+xbtc), cooldown=2, ATR, BTC+ETH")
