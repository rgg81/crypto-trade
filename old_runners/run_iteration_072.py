"""Iter 072: Calendar features — hour of day + day of week (108 features).

Same as iter 068 (ensemble, ATR, cooldown=2, BTC+ETH).
Change: 108 features (106 baseline + 2 calendar).
"""
import sys
import time
...
def main(seed: int = 42) -> None:
    print(f"Iter 072: ensemble + calendar features (108 total), cooldown=2, ATR, BTC+ETH")
