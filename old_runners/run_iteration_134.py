"""Iter 134: A+C+D portfolio — BTC/ETH + LINK + BNB.

Model A: BTC/ETH (iter 093 baseline config)
Model C: LINK (iter 126 config — ATR labeling, auto-discovery)
Model D: BNB (iter 132 config — ATR labeling, auto-discovery)
"""
...
def main() -> None:
    print(f"Iter {ITERATION}: A+C+D PORTFOLIO — BTC/ETH + LINK + BNB")
    print()
