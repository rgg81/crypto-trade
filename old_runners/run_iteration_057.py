"""Iter 057: BTC+ETH, 24mo, TP=8%/SL=4%, timeout=7d, slow features (daily-equiv).

Same config as baseline 047 but with ~56 new daily-equivalent slow features
added to all 6 feature groups (3x lookback multiplier on 8h candles).
"""
import sys, time
...
def main() -> None:
    print(f"Iter 057: BTC+ETH, 24mo, TP=8%/SL=4%, timeout=7d, slow features")
