"""Iter 080: Ternary classification — long/neutral/short.

Timeout candles with |return| < 2% labeled as neutral (class 0).
LightGBM multiclass with 3 classes. Neutral predictions → NO_SIGNAL.
"""
import sys
import time
...
def main(seed: int = 42) -> None:
    print("Iter 080: ternary classification (neutral_threshold=2.0%)")
