"""Iter 137: Model A (BTC+ETH pooled) with ATR labeling 2.9x/1.45x.

Single variable change: enable use_atr_labeling on pooled BTC+ETH model.
Aligns labeling barriers with existing execution barriers (2.9x/1.45x NATR).
"""
...
def main() -> None:
    print(f"Iter {ITERATION}: MODEL A (BTC+ETH) — ATR LABELING 2.9x/1.45x")
    print("=" * 60)
