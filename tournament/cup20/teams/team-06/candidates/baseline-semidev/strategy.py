"""Team 06 TRANSPARENT BASELINE -- one characteristic, no controls, no composite.
...
class DownsideRiskTercile:
    ...
    def target_weights(
        ...
        # THE TRANSPARENT BASELINE: rank on downside semideviation alone.
        score = _zscore(semideviation)
        ...
        # CONTROL REMOVED. The sleeves take equal dollar shares of gross, so the book carries
        # whatever net market beta the risk sort happens to produce.
        long_share = 0.5
