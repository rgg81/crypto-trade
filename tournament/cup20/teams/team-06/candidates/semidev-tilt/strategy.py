"""Team 06 ABLATION -- the single-characteristic baseline WITH the control, completing the 2x2.
...
class DownsideRiskTercile:
    ...
    def target_weights(
        ...
        # One characteristic instead of the four-way composite; the beta tilt below stays on.
