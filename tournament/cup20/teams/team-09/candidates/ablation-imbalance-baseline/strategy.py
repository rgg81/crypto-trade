"""ABLATION -- the transparent baseline: plain USDT-weighted taker imbalance, no conditioning.
...
class PrintSizeFlow:
    ...
    def _measures(self, frame) -> tuple[float, float, float, float, float] | None:
        ...
        # ABLATION: the plain USDT-weighted taker imbalance over the whole window -- the
