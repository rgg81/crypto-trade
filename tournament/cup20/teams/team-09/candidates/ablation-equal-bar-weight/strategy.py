"""ABLATION -- IMBSML replaced by an equal-bar-weight imbalance -- de-weights big bars without using print size.
...
class PrintSizeFlow:
    ...
    def _measures(self, frame) -> tuple[float, float, float, float, float] | None:
        ...
        # ABLATION: the EQUAL-BAR-WEIGHT mean imbalance over the whole window. This removes the
