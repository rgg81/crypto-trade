# team-12 / abl-equal-notional

Control (ablation): the same four sleeves at equal notional.

Identical sleeves, identical cadence and phase; the inverse-volatility multiplier is replaced
by 1 for every sleeve. This is the control that says whether the result depends on the
combination rule or only on owning these four sleeves.
