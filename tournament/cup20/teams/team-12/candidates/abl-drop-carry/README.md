# team-12 / abl-drop-carry

Control (ablation): leave-one-out, the CARRY sleeve removed.

TREND, LOWRISK and FLOW only, combined by the same preregistered rule at the same cadence and
phase. This measures what the weakest sleeve contributes. It is a DIAGNOSTIC: the nominee keeps
all four sleeves, because dropping one after seeing a combined result is re-weighting under
another name and this lane forbids it.
