# Team 07 — Funding carry with crowding-crash protection

Lane id: `funding-carry-crowding-crash-protection`
Playbook: `tournament/cup20/TEAM-PLAYBOOK.md` (read it before you write any code)
Workspace: `tournament/cup20/teams/team-07/`
Data root: `data/cup20/is/`

## Mechanism intent

Perpetual funding is a real cashflow paid by the crowded side, which makes harvesting it the most
literal carry trade in crypto — and also a short-volatility position that pays steadily and then
returns everything in a single cascade. Your lane is that carry **plus** the protection: a mechanism
that recognises when the crowd has become too crowded (funding level and persistence, open-interest
build, basis stretch) and stands aside or inverts before the unwind. The carry alone is a known
trade; whether the protection is real is your actual research question.
