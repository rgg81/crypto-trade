...
All adjacent `*.template.json` files are prospective drafts. A 64-character zero value is a sentinel,
not a real hash; `1970-01-01T00:00:00Z` is a timestamp sentinel. These files must never be passed to a
lifecycle command unchanged.
