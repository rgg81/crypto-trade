...
def candidate_score_values(
    ...
    the values used by portfolio construction.  The candidate-local identity hook preserves
    that boundary without importing a V2 organizer module.
    """
