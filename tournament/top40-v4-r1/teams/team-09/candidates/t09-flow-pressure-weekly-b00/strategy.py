"""Causal weekly taker-flow and price-volume pressure baseline for Team 09."""
    ...
    *,
    ...
    for symbol in sorted(features):
        ...
        if features[symbol].flow_price_alignment <= 0.0:
            score *= parameters.divergence_scale
        scores[symbol] = score
    return scores
