# Team 09 long-confirmed flow pressure: 126/12/2200, fourteen-day

This preregistered low-extreme neighborhood candidate forms a market-neutral spread from completed eight-hour bars and refreshes every fourteen days. It combines
...
and targets 0.22 gross. It uses 126 completed bars for normalization and a 12-bar pressure window.
...
The schedule is anchored to 1970-01-05, a deterministic Monday epoch boundary, and contains no
sample-specific date rule. This is a preregistered low-extreme point and makes no performance claim. Its nearby research
