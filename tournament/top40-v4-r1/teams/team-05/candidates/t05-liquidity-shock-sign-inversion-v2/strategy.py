"""Exact final-target sign inversion of Team 05's liquidity-shock baseline."""
    ...
    def target_weights(
        ...
        *,
        ...
        if (
            ...
            target = {}
        inverted = {symbol: -value for symbol, value in target.items()}
        self._last_decision_time = decision_time
        self._last_target = dict(inverted)
