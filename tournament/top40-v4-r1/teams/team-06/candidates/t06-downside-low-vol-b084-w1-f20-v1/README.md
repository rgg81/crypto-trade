# Team 06 downside-risk neighborhood: 84 bars, weekly, 20% tails

This preregistered neighborhood point estimates each eligible coin's beta to the contemporaneous median-crypto
...
Relative to the parent, it shortens the risk window from 126 to 84 completed eight-hour bars and
narrows each selected tail from 25% to 20%. Weekly scheduling, factor weights, gross exposure and
all organizer-applied risk controls remain unchanged. This is a local stability point, not a
post-result date rule.
