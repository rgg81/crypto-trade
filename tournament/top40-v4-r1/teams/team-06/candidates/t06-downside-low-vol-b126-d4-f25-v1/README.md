# Team 06 downside-risk neighborhood: 126 bars, every four days, 25% tails
...
Relative to the parent, it refreshes every four calendar days rather than weekly. The schedule is
anchored to 1970-01-05, a deterministic Monday epoch boundary, and contains no sample-specific date
rule. The 126-bar risk history, 25% tails, factor weights, gross exposure and organizer-applied risk
controls remain unchanged.

The portfolio owns the broad lowest-risk sleeve and shorts the broad highest-risk sleeve with equal
gross. It requests no rebalance away from the four-day boundary. Minimum history, liquidity, breadth,
