"""Exact target-sign inversion of the Team 08 regime-side center."""
...
class ExactTargetSignInversion:
    def __init__(self) -> None:
        self._reference = FundingCrowdingReversal()
    ...
    def target_weights(
        ...
        *,
        ...
        target = self._reference.target_weights(context, seed=seed)
        if target is None:
            return None
        return {
            symbol: -weight
...
def build_strategy() -> TargetStrategy:
    return ExactTargetSignInversion()
