"""Team 10 persistent-correlation relative value at 315 formation bars."""
...
class StrategyParameters:
    ...
    total_gross: float = 0.90
    maximum_symbol_weight: float = 0.075
    maximum_abs_net: float = 0.075
