"""Volume-confirmed momentum with a causal BTC market-state sleeve budget."""
...
class StrategyParameters:
    ...
    dominant_side_fraction: float = 0.675
    total_gross: float = 0.7
    maximum_symbol_weight: float = 0.06
    maximum_abs_net: float = 0.245
