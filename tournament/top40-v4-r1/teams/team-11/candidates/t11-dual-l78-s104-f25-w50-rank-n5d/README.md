# Team 11 dual-horizon breadth lower-fraction neighbor
...
gross. Each sleeve selects twenty-five percent of the valid cross-section, subject to the eight-name
...
This is the preregistered lower breadth coordinate `(104 weeks, 0.25 fraction)`.
