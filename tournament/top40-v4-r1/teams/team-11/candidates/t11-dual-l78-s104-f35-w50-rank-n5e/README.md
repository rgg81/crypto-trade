# Team 11 dual-horizon breadth upper-fraction neighbor
...
gross. Each sleeve selects thirty-five percent of the valid cross-section, subject to the eight-name
minimum, to diversify the eight-name trial-4 portfolio without increasing rebalance frequency. The
portfolio is held continuously until the next Monday 08:00 UTC decision. Stops,
...
short histories 91/117 weeks and sleeve fractions 0.25/0.35. Era, sleeve, edge, and stressed-cost
failures falsify the candidate.

This is the preregistered upper breadth coordinate `(104 weeks, 0.35 fraction)`.
