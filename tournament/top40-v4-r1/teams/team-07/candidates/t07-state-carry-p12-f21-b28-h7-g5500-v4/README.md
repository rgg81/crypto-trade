# Team 07 4-day residual-trend protection
...
The only executable coordinate is the adverse idiosyncratic trend accumulated over 12
completed 8-hour residual returns (4 days). Residual volatility is estimated from the same
