# Team 07 1-day residual-trend protection
...
The only executable coordinate is the adverse idiosyncratic trend accumulated over 3
completed 8-hour residual returns (1 day). Residual volatility is estimated from the same
