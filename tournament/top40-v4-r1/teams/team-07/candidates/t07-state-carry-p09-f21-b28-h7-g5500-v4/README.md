# Team 07 3-day residual-trend protection
...
The only executable coordinate is the adverse idiosyncratic trend accumulated over 9
completed 8-hour residual returns (3 days). Residual volatility is estimated from the same
