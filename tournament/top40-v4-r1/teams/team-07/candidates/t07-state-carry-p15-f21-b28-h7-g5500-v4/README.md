# Team 07 5-day residual-trend protection
...
The only executable coordinate is the adverse idiosyncratic trend accumulated over 15
completed 8-hour residual returns (5 days). Residual volatility is estimated from the same
