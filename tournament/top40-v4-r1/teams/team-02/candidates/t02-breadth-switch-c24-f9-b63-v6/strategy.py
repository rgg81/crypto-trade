"""Team 02 binary-breadth formation point c24/f9."""
...
class StrategyParameters:
    ...
    channel_days: int = 24
    confirmation_days: int = 9
    breadth_days: int = 63
    breadth_bear_threshold: float = 0.5
    breadth_bull_threshold: float = 0.5
...
def _scores(
    ...
    *,
    ...
    if positive_breadth >= parameters.breadth_bull_threshold:
        return {
            symbol: score if score > 0.0 else 0.0
            for symbol, score in scores.items()
        }
    if positive_breadth <= parameters.breadth_bear_threshold:
        return {
            symbol: score if score < 0.0 else 0.0
            for symbol, score in scores.items()
        }
