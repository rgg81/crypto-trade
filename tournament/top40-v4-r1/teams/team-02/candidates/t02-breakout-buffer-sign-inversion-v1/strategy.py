"""Exact target-sign inversion of Team 02's controls-off fast breakout."""
...
def _scores(
    ...
    *,
    ...
    required_bars = max(channel_bars, confirmation_bars) + 1
...
class BufferedFastBreakout:
    ...
    def target_weights(
        ...
        *,
        ...
        targets = _portfolio(scores, parameters=self.parameters)
