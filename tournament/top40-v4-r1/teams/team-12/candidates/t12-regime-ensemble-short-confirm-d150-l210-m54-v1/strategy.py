"""Team 12 regime ensemble with directional absolute-downtrend short confirmation."""
...
class StrategyParameters:
    ...
    lookback_return_bars: int = 210
    momentum_bars: int = 54
    reversal_bars: int = 6
    downside_bars: int = 126
    regime_lag_bars: int = 3
    btc_direction_bars: int = 150
...
def _confirmed_short_symbols(
    ...
    *,
    ...
    if regime not in {"bull", "bear"} or raw_returns.empty:
        return frozenset()
    result: set[str] = set()
