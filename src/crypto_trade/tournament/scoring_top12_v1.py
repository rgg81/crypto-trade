...
from crypto_trade.tournament import metrics_v3, runner_top12_v1
...
def _artifact(root: Path, result: runner_top12_v1.TeamWindowRunResult, name: str) -> bytes:
...
def summarize_run(
    root: str | Path,
    result: runner_top12_v1.TeamWindowRunResult,
    ...
    *,
    ...
    packet: dict[str, Any] = {
        "schema_version": "top12-v1-run-summary-v1",
        "stage": result.stage,
