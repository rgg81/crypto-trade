...
def _sensitive_paths(root: Path) -> tuple[Path, ...]:
    fixed = (
        ...
        root / "data",
        root / "reports-top40",
        root / "reports-top40-v2",
        root / "reports-top40-v3",
        root / "tournament/top40",
        root / "tournament/top40-v2",
        root / "tournament/top40-v3",
        root / "src/crypto_trade/portfolio",
        root / "analysis/portfolio",
        root / "TOURNAMENT-CHARTER-MN4.md",
        root / "TOURNAMENT-CHARTER-TOP40-V2.md",
        root / "TOURNAMENT-CHARTER-TOP40-V3.md",
    )
    patterns = (
        "reports-*",
        "briefs-portfolio-*",
...
def _load_strategy(bundle: Path, entrypoint: str) -> Any:
    ...
    module_name = f"_top40_v3_strategy_{os.getpid()}"
