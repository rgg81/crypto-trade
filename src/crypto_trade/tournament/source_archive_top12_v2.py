"""Canonical, content-addressed source archives for Top12 V1 candidates.
...
SCHEMA_VERSION = "top12-v2-candidate-source-archive-v1"
ARCHIVE_NAMESPACE = "reports-top12-v2/source-archives/sha256"
...
def _decode_archive(payload: bytes, *, relative_path: str, sha256: str) -> SourceArchive:
    ...
    required_prefix = f"tournament/top12-v2/teams/{team_id}"
