"""v3 tail-risk features — rolling skew/kurt + realized vol + max drawdown.

Track-isolated copy of v2's tail_risk.py. No imports from crypto_trade.features
...
def add_tail_risk_v3_features(df: pd.DataFrame) -> pd.DataFrame:
    """Add v3 tail-risk features to *df*.
