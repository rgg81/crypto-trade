"""Frozen causal contract-unavailability policy for CUP-50 v2."""
...
def load_unavailability_audit(
    ...
    if (
        ...
        or payload.get("namespace") != "cup50v2"
        ...
        raise ValueError("invalid CUP-50 v2 unavailability audit")
...
def unavailable_symbols(
    ...
    return frozenset(window.symbol for window in windows if window.start <= timestamp < window.end)
