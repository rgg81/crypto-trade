"""Physically separate CUP-50 v2 research and sealed snapshots."""
...
def verify_team_visible_snapshot(root: str | Path) -> Mapping[str, object]:
    ...
    if manifest.get("namespace") != "cup50v2-team-visible-is":
        raise ValueError("not a CUP-50 v2 team-visible IS snapshot")
...
def load_snapshot(root: str | Path) -> Snapshot:
    ...
    if manifest.get("namespace") != "cup50v2" or manifest.get("schema_version") != 2:
        raise ValueError("not a CUP-50 v2 snapshot manifest")
