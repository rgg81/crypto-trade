...
def add_cross_btc_v1_features(
    ...
    - **excess_ret_5d_vs_majors_z90**: sym 5-day return minus 50/50 BTC+ETH benchmark,
      ...
      For BTCUSDT, excess = 0.5*(btc_ret - eth_ret). For ETHUSDT, excess = 0.5*(eth_ret -
      btc_ret). For all other symbols (AAVE, DOT, LTC, LINK, etc.), excess measures
      idiosyncratic alt-coin outperformance vs the major benchmark.
