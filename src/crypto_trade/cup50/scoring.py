"""Frozen CUP-50 holdout-only scoring and total ordering."""
...
from crypto_trade.cup50.config import FOLDS, OOS_END, OOS_START
from crypto_trade.cup50.replay import EvaluationResultV2
...
def combine_costs(cells: Mapping[int, CellScore]) -> float:
    if set(cells) != set(_COST_WEIGHTS):
        raise ValueError("a CUP-50 cost aggregate requires exactly 1x, 2x, and 3x cells")
