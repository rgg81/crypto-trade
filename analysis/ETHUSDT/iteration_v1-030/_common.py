...
def drop_horizon_crossing_oos(
    df: pd.DataFrame, horizon: int = HORIZON_CANDLES
) -> pd.DataFrame:
...
def trend_strength_atr_norm(df: pd.DataFrame, sma_window: int = 200, atr_window: int = 14) -> pd.Series:
