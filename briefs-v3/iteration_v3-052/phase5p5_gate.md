...
- Section 10.1 setup commit SHA BACKFILLED: `4cf49e5` — `feat(iter-v3/052): SWAP regime_momentum_signed_3d in / fracdiff_d05_close out of V3_FEATURE_COLUMNS_TOP_N`.
