...
- **Setup commit SHA**: `29ec35e` (this brief — `setup(iter-v3/072): FIXED-HORIZON LABELING + research brief LOCKED`). The `src/` changes (4 files per Section 3.1) and the `ITERATION_LABEL` bump are QE Phase 6 SETUP, committed separately as `feat(iter-v3/072): ...` — QR does not write `src/`.

---

**Brief LOCKED.** EDA SHA `5da9b1b`. Setup commit SHA `29ec35e`.
