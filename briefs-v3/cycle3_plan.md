...
| iter-v3/084 | EXPLORATION #3 | **fresh /059-config anchor re-run on current data** (per the /083 closeout anchor-staleness recommendation) — strongly recommended; carries the MANDATORY `PER_CELL_GAP` 43→22 fix | TBD |
