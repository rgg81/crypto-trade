"""Iter 165: LTC Gate 3 stand-alone screen.

Identical to iter-164 runner except symbol = LTCUSDT. Fail-fast on.

Pass criteria:
  - IS Sharpe > 0
  - IS WR > 33.3%
  - At least 100 IS trades
  - Year-1 cumulative PnL >= 0
"""
...
def main() -> None:
    print("=" * 60)
    print("ITER 165 — LTC Gate 3 STAND-ALONE SCREEN")
    print("=" * 60)
    ...
    try:
        ...
        elapsed = time.time() - t0
        print(f"\nLTC complete: {len(results)} trades in {elapsed:.0f}s")
