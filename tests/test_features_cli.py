...
def test_cmd_features_v2_dispatches_to_features_v2():
    ...
    with (
        patch("crypto_trade.features_v2.run_features_v2", return_value=[]) as v2_run,
...
def test_cmd_features_v1_dispatches_to_features():
    ...
    with (
        patch("crypto_trade.features.run_features", return_value=[]) as v1_run,
...
def test_features_list_track_v2_lists_v2_groups(capsys):
    ...
    with patch("crypto_trade.features_v2.list_groups", return_value=["regime", "tail_risk"]):
        _cmd_features(args, settings)
