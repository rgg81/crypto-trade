...
from crypto_trade.tournament import orchestrator_top12_v1, runner_top12_v1, top12_v1
...
TEAM_ROOT = ROOT / TOP12_V1_LAYOUT.tournament_root / "teams"
...
def test_all_twelve_lanes_have_one_valid_baseline_bundle() -> None:
    ...
    for team_id in TOP12_V1_LAYOUT.team_ids:
        ...
        for strategy_path in candidates:
            ...
            metadata, _relative = orchestrator_top12_v1._candidate_metadata(
...
def test_all_strategy_factories_implement_keyword_only_seed_protocol() -> None:
    for team_id in TOP12_V1_LAYOUT.team_ids:
        for path in sorted((TEAM_ROOT / team_id / "candidates").glob("*/strategy.py")):
            ...
            # actual factory and protocol are exercised only inside runner_top12_v1's sealed worker.
