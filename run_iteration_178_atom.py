"""Iter 178: re-screen ATOM with R1+R2 active from the start.

ATOM was rejected in iter 164 (year-1 fail-fast, 2022 PnL -34.6%).
That iteration used no risk mitigations. With R1 (K=3 C=27) and R2
(t=7/a=15/f=0.33), ATOM may now survive year-1. Same Gate 3 protocol.
"""
