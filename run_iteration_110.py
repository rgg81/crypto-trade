"""Iter 110: DOGE+SHIB with NATR regime filter — skip low-vol choppy market.

Changes from iter 108:
1. Add min_natr_threshold=3.0: skip signals when candle NATR_21 < 3.0%
   (2023 DOGE median NATR was 2.43% — most 2023 candles would be filtered)
2. All else same: 42 features, dynamic ATR labeling, 5-seed ensemble
"""
...
def main(seed: int = 42) -> None:
    print(f"Iter {ITERATION}: DOGE+SHIB, 42 features, NATR regime filter >= 3.0%")
